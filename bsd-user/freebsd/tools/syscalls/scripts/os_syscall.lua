...
-- XXX END
local preamble = require("scripts.helpers.os_syscall.preamble")

os_syscall.file = "/dev/null"

function os_syscall.generate(tbl, config, fh)
	...
	-- xxx Write all the stuff that was there before.
	gen:write(premable.str)
